...
-- `@IsIn` layers (the create vocabulary via the `BIN_TYPES` re-export in
-- `tenancy.dto.ts`; the grid DTO validates the narrowed `GRID_TYPES` imported
-- directly from the primitive) and enforced by the placement/merge/suggestion
-- gates. Additive only; no column change.
